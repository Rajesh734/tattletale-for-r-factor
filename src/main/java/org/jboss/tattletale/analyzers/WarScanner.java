...
public class WarScanner extends AbstractScanner
{
   ...
   {
      return scan(war, null, null, null, null);
   }
                       ...
                       Set<String> blacklisted, Map<String, Object> otherInformation)
   {
      ...
      try
      {
         ...
         String classesName = fileName + "/WEB-INF/classes";
         ...
         warArchive = new WarArchive(fileName, classVersion, lManifest, lSign, requires, provides,
