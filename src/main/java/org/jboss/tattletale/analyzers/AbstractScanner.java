...
import static org.jboss.tattletale.utils.TattleTaleConstants.JDK_VERSION;
...
/**
   ...
   public Integer scanClasses(InputStream is, Set<String> blacklisted, List<Profile> known, Integer classVersion,
                           ...
                           SortedMap<String, SortedSet<String>> blacklistedDependencies, Map<String, Object> otherInformation)
      throws IOException
   {
